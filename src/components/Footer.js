        ...
        */}
        ...
        <div className="footer-link-wrapper">
            <div className="footer-link-item" id="about-card">
              <h2>About</h2>
                ...
                <Link className="footer-link" activeClass="active" to="experience" spy={true} smooth={true} offset={-70} duration={1250}>Experience</Link>
                <Link className="footer-link" activeClass="active" to="research" spy={true} smooth={true} offset={-70} duration={1250}>Research</Link>
                ...
                <a className="footer-link" activeClass="active" spy={true} smooth={true} offset={-70} duration={1250}
                  href={`mailto:krutharth07@gmail.com?subject=${subject}&body=${body}`} target="_blank" without rel="noopener noreferrer">Resume</a>
							</div>
        ...
        <section className="social-media">
          <div className="social-media-wrap">
            ...
            <a href="mailto: krutharth07@gmail.com"
              ...
              <a href="https://www.linkedin.com/in/krutharth1047/"
